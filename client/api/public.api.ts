...
export const publicApi = {
  ...
  async getProducts(params?: PublicProductsQuery): Promise<PublicProductsPageResponse> {
    const response = await axiosInstance.get<PublicProductsPageResponse>("/public/products", {
      params,
    });
    return response.data;
  },
  ...
  async getPosts(params?: PublicPostsQuery): Promise<PublicPostsPageResponse> {
    const response = await axiosInstance.get<PublicPostsPageResponse>("/public/posts", {
      params,
    });
    return response.data;
  },
  ...
  async getProjects(params?: PublicProjectsQuery): Promise<PublicProjectsPageResponse> {
    const response = await axiosInstance.get<PublicProjectsPageResponse>("/public/projects", {
      params,
    });
    return response.data;
  },
  ...
  async getServiceBySlug(slug: string): Promise<PublicServiceFeatureResponse> {
    const response = await axiosInstance.get<PublicServiceFeatureResponse>(
